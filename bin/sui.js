...
DemoObject.main = function() {
	...
	folder.control("scores",(function(v) {
	...
	folder.control("name",sui.Sui.createText(o.name),function(v3) {
		o.name = v3;
	});
	folder.control("started on",sui.Sui.createDate(o.startedOn),function(v4) {
		o.startedOn = v4;
	});
	folder.control("info",(function(v5) {
	...
	folder.control("enabled",sui.Sui.createBool(o.get_enabled()),function(v9) {
		o.set_enabled(v9);
	});
	folder.control(null,sui.Sui.createTrigger("trace me"),function(_) {
		o.traceMe();
	});
	folder;
	sui1.attach();
...
DemoObject.prototype = {
	...
	,traceMe: function() {
		...
		}).join(", "),{ fileName : "DemoObject.hx", lineNumber : 26, className : "DemoObject", methodName : "traceMe"});
	}
	,get_enabled: function() {
		return this.enabled;
	}
	,set_enabled: function(v) {
		haxe.Log.trace("enabled set to " + (v == null?"null":"" + v),{ fileName : "DemoObject.hx", lineNumber : 34, className : "DemoObject", methodName : "set_enabled"});
...
sui.Sui.prototype = {
	...
	,folder: function(label,options) {
		...
		if(collapsible) {
			...
			var collapse = thx.stream.EmitterBools.negate(thx.stream.dom.Dom.streamEvent(trigger,"click",false).map(function(_) {
