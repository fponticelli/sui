...
sui.Sui.prototype = {
	...
	,choice: function(label) {
		var create = function(option) {
			...
			case "b":
				var sui1 = new sui.Sui();
				sui1["int"]("number",null,{ min : 0, max : 10},function(_2) {
				});
				return sui1;
			default:
				return null;
		...
		var list = [{ value : "a", label : "A"},{ value : "b", label : "B"},{ value : "c", label : "C"}];
		var select = sui.Sui.createText("a",{ listonly : true, list : list});
