...
var DemoObject = function() {
	this.option = haxe_ds_Option.None;
};
...
DemoObject.main = function() {
	...
	folder.control("option",(function(v) {
		var controls = [];
		return new sui_controls_MultiControl(v,null,controls);
	})(o.option),function(v1) {
		o.option = v1;
	});
	folder.control(null,sui_Sui.createTrigger("trace me"),function(_) {
		o.traceMe();
	});
	folder;
	sui1.attach();
...
DemoObject.prototype = {
	...
	,traceMe: function() {
		var _g = this;
		haxe_Log.trace(Reflect.fields(this).map(function(field) {
			return "" + field + ": " + Std.string(Reflect.field(_g,field));
		}).join(", "),{ fileName : "DemoObject.hx", lineNumber : 32, className : "DemoObject", methodName : "traceMe"});
	}
...
var sui_controls_MultiControl = function(defaultValue,element,controls) {
	var _g = this;
	this.el = element;
	this.defaultValue = defaultValue;
	...
	this.values = new sui_controls_ControlValues(defaultValue);
	this.streams = new sui_controls_ControlStreams(this.values.value,this.values.focused,this.values.enabled);
	controls.map(function(_) {
		return _.streams.focused.feed(_g.values.focused);
	});
	this.streams.enabled.subscribe(function(value) {
		controls.map(function(_1) {
			if(value) _1.enable(); else _1.disable();
			return;
		});
	});
};
sui_controls_MultiControl.__name__ = ["sui","controls","MultiControl"];
sui_controls_MultiControl.__interfaces__ = [sui_controls_IControl];
sui_controls_MultiControl.prototype = {
	el: null
	,defaultValue: null
	,streams: null
	,controls: null
	...
	,blur: function() {
		...
		(function(_) {
			if(null == _) null; else el.blur();
			return;
		})(thx_Arrays.first(this.controls.filter(function(_1) {
			return _1.el == el;
		})));
	}
	,reset: function() {
	...
	,__class__: sui_controls_MultiControl
};
