...
DemoObject.prototype = {
	traceMe: function() {
		...
		}).join(", "),{ fileName : "DemoObject.hx", lineNumber : 27, className : "DemoObject", methodName : "traceMe"});
	}
	,get_enabled: function() {
		return this.enabled;
	}
	,set_enabled: function(v) {
		haxe.Log.trace("enabled set to " + (v == null?"null":"" + v),{ fileName : "DemoObject.hx", lineNumber : 35, className : "DemoObject", methodName : "set_enabled"});
