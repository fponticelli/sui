...
sui.controls.ArrayControl.prototype = {
	addControl: function(value) {
		...
		thx.stream.dom.Dom.streamEvent(removeElement,"click",false).subscribe(function(_) {
			...
			haxe.Log.trace(_g.arr,{ fileName : "ArrayControl.hx", lineNumber : 96, className : "sui.controls.ArrayControl", methodName : "addControl"});
			_g.arr.splice(o.index,1);
			haxe.Log.trace(_g.arr,{ fileName : "ArrayControl.hx", lineNumber : 98, className : "sui.controls.ArrayControl", methodName : "addControl"});
			var _g2 = o.index;
